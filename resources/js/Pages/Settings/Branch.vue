            ...
            <el-skeleton :loading="isLoading" animated>
                ...
                <template #default>
                    <el-table class="min-w-full" 
                        ...
                        <el-table-column :label="$t('common.addd_at')">
...
const {
    ...
    queryKey: ['branchList', params.value], // Query key unik
    queryFn: fetchData,
...
const openModal = () => {
    formTitle.value = `${ t('common.add') } ${ t('base.branch') }`;
    formShow.value = true;
    form.value.id = null;
...
const onEdit = (data) => {
    formTitle.value = `${ t('common.edit') } ${ t('base.branch') }`;
    formShow.value = true;
